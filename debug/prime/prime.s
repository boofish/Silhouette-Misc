...
prime.elf:     file format elf32-littlearm
...
08001eb6 <benchmark>:
 8001eb6:	f640 23f0 	movw	r3, #2800	; 0xaf0
 8001eba:	f640 22ec 	movw	r2, #2796	; 0xaec
 8001ebe:	f2c2 0300 	movt	r3, #8192	; 0x2000
 8001ec2:	f2c2 0200 	movt	r2, #8192	; 0x2000
 8001ec6:	6819      	ldr	r1, [r3, #0]
 8001ec8:	f8d2 c000 	ldr.w	ip, [r2]
 8001ecc:	f011 0f01 	tst.w	r1, #1
 8001ed0:	6011      	str	r1, [r2, #0]
 8001ed2:	f8c3 c000 	str.w	ip, [r3]
 8001ed6:	d103      	bne.n	8001ee0 <benchmark+0x2a>
 8001ed8:	2902      	cmp	r1, #2
 8001eda:	d011      	beq.n	8001f00 <benchmark+0x4a>
 8001edc:	2001      	movs	r0, #1
 8001ede:	e032      	b.n	8001f46 <benchmark+0x90>
 8001ee0:	2909      	cmp	r1, #9
 8001ee2:	d30b      	bcc.n	8001efc <benchmark+0x46>
 8001ee4:	2205      	movs	r2, #5
 8001ee6:	1e93      	subs	r3, r2, #2
 8001ee8:	fbb1 f0f3 	udiv	r0, r1, r3
 8001eec:	fb00 1013 	mls	r0, r0, r3, r1
 8001ef0:	b178      	cbz	r0, 8001f12 <benchmark+0x5c>
 8001ef2:	1c93      	adds	r3, r2, #2
 8001ef4:	4352      	muls	r2, r2
 8001ef6:	428a      	cmp	r2, r1
 8001ef8:	461a      	mov	r2, r3
 8001efa:	d9f4      	bls.n	8001ee6 <benchmark+0x30>
 8001efc:	2902      	cmp	r1, #2
 8001efe:	d308      	bcc.n	8001f12 <benchmark+0x5c>
 8001f00:	ea5f 70cc 	movs.w	r0, ip, lsl #31
 8001f04:	d107      	bne.n	8001f16 <benchmark+0x60>
 8001f06:	2100      	movs	r1, #0
 8001f08:	f1bc 0f02 	cmp.w	ip, #2
 8001f0c:	bf08      	it	eq
 8001f0e:	2101      	moveq	r1, #1
 8001f10:	e017      	b.n	8001f42 <benchmark+0x8c>
 8001f12:	2001      	movs	r0, #1
 8001f14:	e017      	b.n	8001f46 <benchmark+0x90>
 8001f16:	f1bc 0f09 	cmp.w	ip, #9
 8001f1a:	d30b      	bcc.n	8001f34 <benchmark+0x7e>
 8001f1c:	2105      	movs	r1, #5
 8001f1e:	1e88      	subs	r0, r1, #2
 8001f20:	fbbc f2f0 	udiv	r2, ip, r0
 8001f24:	fb02 c010 	mls	r0, r2, r0, ip
 8001f28:	b150      	cbz	r0, 8001f40 <benchmark+0x8a>
 8001f2a:	1c88      	adds	r0, r1, #2
 8001f2c:	4349      	muls	r1, r1
 8001f2e:	4561      	cmp	r1, ip
 8001f30:	4601      	mov	r1, r0
 8001f32:	d9f4      	bls.n	8001f1e <benchmark+0x68>
 8001f34:	2100      	movs	r1, #0
 8001f36:	f1bc 0f01 	cmp.w	ip, #1
 8001f3a:	bf88      	it	hi
 8001f3c:	2101      	movhi	r1, #1
 8001f3e:	e000      	b.n	8001f42 <benchmark+0x8c>
 8001f40:	2100      	movs	r1, #0
 8001f42:	f081 0001 	eor.w	r0, r1, #1
 8001f46:	f640 11e4 	movw	r1, #2532	; 0x9e4
 8001f4a:	f2c2 0100 	movt	r1, #8192	; 0x2000
 8001f4e:	6008      	str	r0, [r1, #0]
 8001f50:	2000      	movs	r0, #0
 8001f52:	4770      	bx	lr

08001f54 <initialise_benchmark>:
 8001f54:	f640 20ec 	movw	r0, #2796	; 0xaec
 8001f58:	f245 4191 	movw	r1, #21649	; 0x5491
 8001f5c:	f2c2 0000 	movt	r0, #8192	; 0x2000
 8001f60:	6001      	str	r1, [r0, #0]
 8001f62:	f640 20f0 	movw	r0, #2800	; 0xaf0
 8001f66:	f24d 41d7 	movw	r1, #54487	; 0xd4d7
 8001f6a:	f2c2 0000 	movt	r0, #8192	; 0x2000
 8001f6e:	f2c0 0107 	movt	r1, #7
 8001f72:	6001      	str	r1, [r0, #0]
 8001f74:	4770      	bx	lr

08001f76 <verify_benchmark>:
 8001f76:	f640 10e4 	movw	r0, #2532	; 0x9e4
 8001f7a:	f2c2 0000 	movt	r0, #8192	; 0x2000
 8001f7e:	6801      	ldr	r1, [r0, #0]
 8001f80:	2000      	movs	r0, #0
 8001f82:	2900      	cmp	r1, #0
 8001f84:	bf08      	it	eq
 8001f86:	2001      	moveq	r0, #1
 8001f88:	4770      	bx	lr
...
08001fac <main>:
 ...
 8001fb0:	f640 11e8 	movw	r1, #2536	; 0x9e8
 ...
 8001fe2:	f7ff ffb7 	bl	8001f54 <initialise_benchmark>
...
080020a4 <_sbrk>:
 80020a4:	f640 226c 	movw	r2, #2668	; 0xa6c
...
08005138 <_malloc_trim_r>:
 ...
 80051d0:	20000a70 	.word	0x20000a70
...
0800582c <_malloc_r>:
 ...
 8005b68:	20000aa0 	.word	0x20000aa0
 8005b6c:	20000a70 	.word	0x20000a70
 8005b70:	20000a98 	.word	0x20000a98
 8005b74:	20000a9c 	.word	0x20000a9c
 ...
 8005d6e:	bf00      	nop
 8005d70:	20000a70 	.word	0x20000a70
