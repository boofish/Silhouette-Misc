...
insertsort.elf:     file format elf32-littlearm
...
08001eb6 <benchmark>:
 ...
 8001eba:	f640 2ce8 	movw	ip, #2792	; 0xae8
 8001ebe:	2202      	movs	r2, #2
 8001ec0:	f2c2 0c00 	movt	ip, #8192	; 0x2000
 8001ec4:	f10c 0e04 	add.w	lr, ip, #4
 8001ec8:	e006      	b.n	8001ed8 <benchmark+0x22>
 8001eca:	3201      	adds	r2, #1
 8001ecc:	f10e 0e04 	add.w	lr, lr, #4
 8001ed0:	2a0b      	cmp	r2, #11
 8001ed2:	bf04      	itt	eq
 8001ed4:	2000      	moveq	r0, #0
 8001ed6:	bd80      	popeq	{r7, pc}
 8001ed8:	eb0c 0082 	add.w	r0, ip, r2, lsl #2
 8001edc:	f85c 3022 	ldr.w	r3, [ip, r2, lsl #2]
 8001ee0:	f850 0c04 	ldr.w	r0, [r0, #-4]
 8001ee4:	4283      	cmp	r3, r0
 8001ee6:	d2f0      	bcs.n	8001eca <benchmark+0x14>
 8001ee8:	4671      	mov	r1, lr
 8001eea:	e9c1 3000 	strd	r3, r0, [r1]
 8001eee:	f851 0d04 	ldr.w	r0, [r1, #-4]!
 8001ef2:	4283      	cmp	r3, r0
 8001ef4:	d3f9      	bcc.n	8001eea <benchmark+0x34>
 8001ef6:	e7e8      	b.n	8001eca <benchmark+0x14>

08001ef8 <initialise_benchmark>:
 8001ef8:	f640 20e8 	movw	r0, #2792	; 0xae8
 8001efc:	2100      	movs	r1, #0
 8001efe:	2203      	movs	r2, #3
 8001f00:	2302      	movs	r3, #2
 8001f02:	f2c2 0000 	movt	r0, #8192	; 0x2000
 8001f06:	6001      	str	r1, [r0, #0]
 8001f08:	210b      	movs	r1, #11
 8001f0a:	6041      	str	r1, [r0, #4]
 8001f0c:	210a      	movs	r1, #10
 8001f0e:	6081      	str	r1, [r0, #8]
 8001f10:	2109      	movs	r1, #9
 8001f12:	60c1      	str	r1, [r0, #12]
 8001f14:	2108      	movs	r1, #8
 8001f16:	6101      	str	r1, [r0, #16]
 8001f18:	2107      	movs	r1, #7
 8001f1a:	6141      	str	r1, [r0, #20]
 8001f1c:	2106      	movs	r1, #6
 8001f1e:	6181      	str	r1, [r0, #24]
 8001f20:	2105      	movs	r1, #5
 8001f22:	61c1      	str	r1, [r0, #28]
 8001f24:	2104      	movs	r1, #4
 8001f26:	3020      	adds	r0, #32
 8001f28:	c00e      	stmia	r0!, {r1, r2, r3}
 8001f2a:	4770      	bx	lr

08001f2c <verify_benchmark>:
 8001f2c:	b580      	push	{r7, lr}
 8001f2e:	466f      	mov	r7, sp
 8001f30:	f640 21e8 	movw	r1, #2792	; 0xae8
 8001f34:	f04f 0c00 	mov.w	ip, #0
 8001f38:	f2c2 0100 	movt	r1, #8192	; 0x2000
 8001f3c:	e9d1 2300 	ldrd	r2, r3, [r1]
 8001f40:	e9d1 0e02 	ldrd	r0, lr, [r1, #8]
 ...
 8001f54:	bf08      	it	eq
 8001f56:	2201      	moveq	r2, #1
 8001f58:	2803      	cmp	r0, #3
 8001f5a:	f04f 0000 	mov.w	r0, #0
 8001f5e:	bf08      	it	eq
 8001f60:	2001      	moveq	r0, #1
 8001f62:	401a      	ands	r2, r3
 8001f64:	f1be 0f04 	cmp.w	lr, #4
 8001f68:	ea00 0002 	and.w	r0, r0, r2
 8001f6c:	f04f 0200 	mov.w	r2, #0
 8001f70:	bf08      	it	eq
 8001f72:	2201      	moveq	r2, #1
 8001f74:	4010      	ands	r0, r2
 8001f76:	690a      	ldr	r2, [r1, #16]
 8001f78:	2a05      	cmp	r2, #5
 8001f7a:	f04f 0200 	mov.w	r2, #0
 8001f7e:	bf08      	it	eq
 8001f80:	2201      	moveq	r2, #1
 8001f82:	4010      	ands	r0, r2
 8001f84:	694a      	ldr	r2, [r1, #20]
 8001f86:	2a06      	cmp	r2, #6
 8001f88:	f04f 0200 	mov.w	r2, #0
 8001f8c:	bf08      	it	eq
 8001f8e:	2201      	moveq	r2, #1
 8001f90:	4010      	ands	r0, r2
 8001f92:	698a      	ldr	r2, [r1, #24]
 8001f94:	2a07      	cmp	r2, #7
 8001f96:	f04f 0200 	mov.w	r2, #0
 8001f9a:	bf08      	it	eq
 8001f9c:	2201      	moveq	r2, #1
 8001f9e:	4010      	ands	r0, r2
 8001fa0:	69ca      	ldr	r2, [r1, #28]
 8001fa2:	2a08      	cmp	r2, #8
 8001fa4:	f04f 0200 	mov.w	r2, #0
 8001fa8:	bf08      	it	eq
 8001faa:	2201      	moveq	r2, #1
 8001fac:	4010      	ands	r0, r2
 8001fae:	e9d1 2308 	ldrd	r2, r3, [r1, #32]
 8001fb2:	6a89      	ldr	r1, [r1, #40]	; 0x28
 8001fb4:	2a09      	cmp	r2, #9
 8001fb6:	f04f 0200 	mov.w	r2, #0
 8001fba:	bf08      	it	eq
 8001fbc:	2201      	moveq	r2, #1
 8001fbe:	2b0a      	cmp	r3, #10
 8001fc0:	ea00 0002 	and.w	r0, r0, r2
 8001fc4:	f04f 0200 	mov.w	r2, #0
 8001fc8:	bf08      	it	eq
 8001fca:	2201      	moveq	r2, #1
 8001fcc:	290b      	cmp	r1, #11
 8001fce:	ea00 0002 	and.w	r0, r0, r2
 8001fd2:	bf08      	it	eq
 8001fd4:	f04f 0c01 	moveq.w	ip, #1
 8001fd8:	ea00 000c 	and.w	r0, r0, ip
 8001fdc:	bd80      	pop	{r7, pc}

08001fde <__io_putchar>:
 8001fde:	b580      	push	{r7, lr}
 8001fe0:	466f      	mov	r7, sp
 8001fe2:	b082      	sub	sp, #8
 8001fe4:	9001      	str	r0, [sp, #4]
 8001fe6:	f640 10e4 	movw	r0, #2532	; 0x9e4
 8001fea:	a901      	add	r1, sp, #4
 8001fec:	2201      	movs	r2, #1
 8001fee:	f64f 73ff 	movw	r3, #65535	; 0xffff
 8001ff2:	f2c2 0000 	movt	r0, #8192	; 0x2000
 8001ff6:	f7ff fe70 	bl	8001cda <HAL_UART_Transmit>
...
08002000 <main>:
 ...
 8002004:	f640 11e4 	movw	r1, #2532	; 0x9e4
 8002008:	f643 0000 	movw	r0, #14336	; 0x3800
 800200c:	220c      	movs	r2, #12
 800200e:	f2c2 0100 	movt	r1, #8192	; 0x2000
 8002012:	f2c4 0001 	movt	r0, #16385	; 0x4001
 8002016:	6008      	str	r0, [r1, #0]
 8002018:	f44f 30e1 	mov.w	r0, #115200	; 0x1c200
 800201c:	6048      	str	r0, [r1, #4]
 800201e:	2000      	movs	r0, #0
 8002020:	e9c1 0002 	strd	r0, r0, [r1, #8]
 8002024:	6108      	str	r0, [r1, #16]
 8002026:	6248      	str	r0, [r1, #36]	; 0x24
 8002028:	e9c1 0007 	strd	r0, r0, [r1, #28]
 800202c:	e9c1 2005 	strd	r2, r0, [r1, #20]
 8002030:	2000      	movs	r0, #0
 8002032:	f7ff fee7 	bl	8001e04 <BSP_COM_Init>
 8002036:	f7ff ff5f 	bl	8001ef8 <initialise_benchmark>
 800203a:	f646 70f8 	movw	r0, #28664	; 0x6ff8
 800203e:	f6c0 0000 	movt	r0, #2048	; 0x800
 8002042:	f000 f949 	bl	80022d8 <printf>
 8002046:	f247 00a5 	movw	r0, #28837	; 0x70a5
 800204a:	f6c0 0000 	movt	r0, #2048	; 0x800
 800204e:	f000 f9a5 	bl	800239c <puts>
 8002052:	f7ff f849 	bl	80010e8 <HAL_Init>
 8002056:	f7ff f85f 	bl	8001118 <HAL_GetTick>
 800205a:	4604      	mov	r4, r0
 800205c:	f7ff ff2b 	bl	8001eb6 <benchmark>
 8002060:	4605      	mov	r5, r0
 8002062:	f7ff f859 	bl	8001118 <HAL_GetTick>
 8002066:	1b04      	subs	r4, r0, r4
 8002068:	4628      	mov	r0, r5
 800206a:	f7ff ff5f 	bl	8001f2c <verify_benchmark>
 800206e:	1c41      	adds	r1, r0, #1
 8002070:	d006      	beq.n	8002080 <main+0x80>
 8002072:	2801      	cmp	r0, #1
 8002074:	d109      	bne.n	800208a <main+0x8a>
 8002076:	f247 0011 	movw	r0, #28689	; 0x7011
 800207a:	f6c0 0000 	movt	r0, #2048	; 0x800
 800207e:	e008      	b.n	8002092 <main+0x92>
 8002080:	f247 0035 	movw	r0, #28725	; 0x7035
 8002084:	f6c0 0000 	movt	r0, #2048	; 0x800
 8002088:	e003      	b.n	8002092 <main+0x92>
 800208a:	f247 006a 	movw	r0, #28778	; 0x706a
 800208e:	f6c0 0000 	movt	r0, #2048	; 0x800
 8002092:	4621      	mov	r1, r4
 8002094:	f000 f920 	bl	80022d8 <printf>
 8002098:	2000      	movs	r0, #0
 800209a:	bdb0      	pop	{r4, r5, r7, pc}

0800209c <SysTick_Handler>:
 800209c:	b580      	push	{r7, lr}
 800209e:	466f      	mov	r7, sp
 80020a0:	f7ff f832 	bl	8001108 <HAL_IncTick>
 80020a4:	e8bd 4080 	ldmia.w	sp!, {r7, lr}
 80020a8:	f7ff b88c 	b.w	80011c4 <HAL_SYSTICK_IRQHandler>

080020ac <_read>:
 80020ac:	b5f0      	push	{r4, r5, r6, r7, lr}
 80020ae:	af03      	add	r7, sp, #12
 80020b0:	f84d bd04 	str.w	fp, [sp, #-4]!
 80020b4:	4614      	mov	r4, r2
 80020b6:	460d      	mov	r5, r1
 80020b8:	2c01      	cmp	r4, #1
 80020ba:	db06      	blt.n	80020ca <_read+0x1e>
 80020bc:	4626      	mov	r6, r4
 80020be:	f3af 8000 	nop.w
 80020c2:	f805 0b01 	strb.w	r0, [r5], #1
 80020c6:	3e01      	subs	r6, #1
 80020c8:	d1f9      	bne.n	80020be <_read+0x12>
 80020ca:	4620      	mov	r0, r4
 80020cc:	f85d bb04 	ldr.w	fp, [sp], #4
 80020d0:	bdf0      	pop	{r4, r5, r6, r7, pc}

080020d2 <_write>:
 80020d2:	b5f0      	push	{r4, r5, r6, r7, lr}
 80020d4:	af03      	add	r7, sp, #12
 80020d6:	f84d bd04 	str.w	fp, [sp, #-4]!
 80020da:	4614      	mov	r4, r2
 80020dc:	460d      	mov	r5, r1
 80020de:	2c01      	cmp	r4, #1
 80020e0:	db06      	blt.n	80020f0 <_write+0x1e>
 80020e2:	4626      	mov	r6, r4
 80020e4:	f815 0b01 	ldrb.w	r0, [r5], #1
 80020e8:	f7ff ff79 	bl	8001fde <__io_putchar>
 80020ec:	3e01      	subs	r6, #1
 80020ee:	d1f9      	bne.n	80020e4 <_write+0x12>
 80020f0:	4620      	mov	r0, r4
 80020f2:	f85d bb04 	ldr.w	fp, [sp], #4
 80020f6:	bdf0      	pop	{r4, r5, r6, r7, pc}

080020f8 <_sbrk>:
 80020f8:	f640 2268 	movw	r2, #2664	; 0xa68
 80020fc:	4601      	mov	r1, r0
 80020fe:	466b      	mov	r3, sp
 8002100:	f2c2 0200 	movt	r2, #8192	; 0x2000
 8002104:	6810      	ldr	r0, [r2, #0]
 8002106:	2800      	cmp	r0, #0
 8002108:	bf02      	ittt	eq
 800210a:	f640 3040 	movweq	r0, #2880	; 0xb40
 800210e:	f2c2 0000 	movteq	r0, #8192	; 0x2000
 8002112:	6010      	streq	r0, [r2, #0]
 8002114:	4401      	add	r1, r0
 8002116:	4299      	cmp	r1, r3
 8002118:	bf9c      	itt	ls
 800211a:	6011      	strls	r1, [r2, #0]
 800211c:	4770      	bxls	lr
 800211e:	b580      	push	{r7, lr}
 8002120:	466f      	mov	r7, sp
 8002122:	f000 f865 	bl	80021f0 <__errno>
 8002126:	210c      	movs	r1, #12
...
08002136 <_fstat>:
 8002136:	f44f 5000 	mov.w	r0, #8192	; 0x2000
 800213a:	6048      	str	r0, [r1, #4]
...
08002148 <SystemInit>:
 8002148:	f64e 5088 	movw	r0, #60808	; 0xed88
 800214c:	f04f 0c00 	mov.w	ip, #0
 8002150:	f2ce 0000 	movt	r0, #57344	; 0xe000
 8002154:	6801      	ldr	r1, [r0, #0]
 8002156:	f441 0170 	orr.w	r1, r1, #15728640	; 0xf00000
 800215a:	6001      	str	r1, [r0, #0]
 800215c:	f241 0100 	movw	r1, #4096	; 0x1000
 8002160:	f2c4 0102 	movt	r1, #16386	; 0x4002
 8002164:	680a      	ldr	r2, [r1, #0]
 8002166:	f042 0201 	orr.w	r2, r2, #1
 800216a:	600a      	str	r2, [r1, #0]
 800216c:	f8c1 c008 	str.w	ip, [r1, #8]
 8002170:	f64f 72ff 	movw	r2, #65535	; 0xffff
 8002174:	680b      	ldr	r3, [r1, #0]
 8002176:	f6ce 22f6 	movt	r2, #60150	; 0xeaf6
 800217a:	401a      	ands	r2, r3
 800217c:	600a      	str	r2, [r1, #0]
 800217e:	f44f 5280 	mov.w	r2, #4096	; 0x1000
 8002182:	60ca      	str	r2, [r1, #12]
 8002184:	680a      	ldr	r2, [r1, #0]
 8002186:	f422 2280 	bic.w	r2, r2, #262144	; 0x40000
 800218a:	600a      	str	r2, [r1, #0]
 800218c:	f8c1 c018 	str.w	ip, [r1, #24]
 8002190:	f04f 6100 	mov.w	r1, #134217728	; 0x8000000
 8002194:	f840 1c80 	str.w	r1, [r0, #-128]
 8002198:	4770      	bx	lr
	...
...
080021c0 <LoopFillZerobss>:
 ...
 80021c6:	f7ff ffbf 	bl	8002148 <SystemInit>
 80021ca:	f000 f817 	bl	80021fc <__libc_init_array>
 80021ce:	f7ff ff17 	bl	8002000 <main>
...
080021d2 <LoopForever>:
 ...
 80021e0:	200009c8 	.word	0x200009c8
 80021e4:	200009c8 	.word	0x200009c8
 80021e8:	20000b3c 	.word	0x20000b3c
...
080050ec <__sinit>:
 ...
 800513a:	bf00      	nop
 800513c:	20000b20 	.word	0x20000b20
...
08005150 <__sfp_lock_release>:
 ...
 8005156:	bf00      	nop
 8005158:	20000b34 	.word	0x20000b34
...
08005e94 <__malloc_lock>:
 ...
 8005e9a:	bf00      	nop
 8005e9c:	20000b24 	.word	0x20000b24
...
08005ea0 <__malloc_unlock>:
 ...
 8005ea6:	bf00      	nop
 8005ea8:	20000b24 	.word	0x20000b24
...
08006884 <_sbrk_r>:
 ...
 8006890:	f7fb fc32 	bl	80020f8 <_sbrk>
 ...
 80068a4:	20000b38 	.word	0x20000b38
...
08006a20 <_write_r>:
 ...
 8006a32:	f7fb fb4e 	bl	80020d2 <_write>
 ...
 8006a46:	bf00      	nop
 8006a48:	20000b38 	.word	0x20000b38
...
08006b74 <_close_r>:
 ...
 8006b80:	f7fb fad6 	bl	8002130 <_close>
 ...
 8006b94:	20000b38 	.word	0x20000b38
...
08006d6c <_fstat_r>:
 ...
 8006d7c:	f7fb f9db 	bl	8002136 <_fstat>
 ...
 8006d90:	20000b38 	.word	0x20000b38
...
08006d94 <_isatty_r>:
 ...
 8006da0:	f7fb f9ce 	bl	8002140 <_isatty>
 ...
 8006db4:	20000b38 	.word	0x20000b38
...
08006dd4 <_lseek_r>:
 ...
 8006de6:	f7fb f9ad 	bl	8002144 <_lseek>
 ...
 8006dfa:	bf00      	nop
 8006dfc:	20000b38 	.word	0x20000b38
...
08006e2c <_read_r>:
 ...
 8006e3e:	f7fb f935 	bl	80020ac <_read>
